                                                ...
                                                <div class="pb-1">
                                                    <div class="row">
                                                        <div class="col-12 text-center pb-1">
                                                            ...
                                                            <img class="rounded border border-2 border-dark" src="https://chart.googleapis.com/chart?cht=qr&chl={{ @$method->wallet_address }}&chs=180x180&choe=UTF-8&chld=L|2" alt="QR Code">
                                                            <h4 class="text-danger pt-2">OR</h4>
                                                        </div>
                                                        <div class="col-12 text-center">
                                                            <h6 class="text-warning">=== {{ @$method->wallet_address_lab }} ===</h6>
                                                        </div>
                                                    </div>

                                                    <div align="center" class="row pt-1 pb-1">
                                                        <div class="col px-0">
                                                            <input class="form-control border-custom text-center " type="text" value="{{ @$method->wallet_address }}" id="addressURL" readonly>
                                                        </div>
                                                        <div class="col-auto px-1"> <h4 class="btn btn-warning bg-gradiant text-white border-custom px-4" id="copyBoard">Copy</h4></div>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
